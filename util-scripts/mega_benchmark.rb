...
FactoryBot.attributes_for(:amqp_course)
# FactoryBot.attributes_for(:amqp_item)
FactoryBot.attributes_for(:amqp_enrollment)

course1_event_data = FactoryBot.attributes_for(:amqp_course)
course1_event_data[:title] = "Course 1"
course2_event_data = FactoryBot.attributes_for(:amqp_course)
...
FactoryBot.attributes_for(:amqp_user)
