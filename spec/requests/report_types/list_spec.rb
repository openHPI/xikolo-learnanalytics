...
describe 'ReportTypes: List', type: :request do
  ...
  context 'without openwho reports' do
    let(:report_types) do
      <<~YML
        reports:
          types:
    ...
    it { expect(resource).to eq general_reports }
  end

  context 'with openwho reports' do
    let(:report_types) do
      <<~YML
        reports:
          types:
    ...
    it { expect(resource).to eq general_reports + openwho_reports }
  end
end
