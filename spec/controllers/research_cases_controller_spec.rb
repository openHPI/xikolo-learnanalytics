...
RSpec.describe ResearchCasesController, :type => :controller do
  ...
  # ResearchCasesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all research_cases as @research_cases" do
      research_case = ResearchCase.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:research_cases)).to eq([research_case])
    end
  end
