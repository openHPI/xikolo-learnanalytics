FactoryBot.define do
  ...
  # {"id"=>"d6e4551f-44bc-4e97-9099-eecf04adfd9b", "url"=>"http://localhost:3000/", "language"=>"en", "mail"=>"asdasd@example.com", "report"=>"HelpHelp", "course_id"=>"00000001-3300-4444-9999-000000000007", "title"=>"Help", "data"=>"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.104 Safari/537.36:true:en-US", "user_id"=>nil}
