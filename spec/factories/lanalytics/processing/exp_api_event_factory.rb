...
FactoryBot.define do
  ...
  factory :viewed_page_event, class: Hash do
    ...
    creation_timestamp    { Time.now.to_f }
    in_context do  {
      'user_ip' => '2001:638:807:208:148b:8e62:85ee:547b',
      'user_os' => 'MacIntel',
      'user_agent' => 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.91 Safari/537.36',
      'user_app_version' => '5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.91 Safari/537.36',
      'user_location_city' => 'Potsdam',
      'user_location_country_code' => 'DE',
      'user_location_country_name' => 'Germany',
      'user_location_latitude' => '52.4',
      'user_location_longitude' => '13.067',
      'user_location_time_zone' => 'Europe/Berlin'
    }
    end
  end
