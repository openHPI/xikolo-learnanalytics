...
describe AccessGroups do
  ...
  let(:user_id_1) { '98098dfd-dbe1-4897-888a-c919fe64d727' }
  let(:user_id_2) { '7790394d-e9e5-404c-97a9-0d4aa7a15160' }
  let(:user_id_3) { '6dcea948-b486-4e59-981e-c028883154dd' }
