...
RSpec.describe Lanalytics::TrackingController, :type => :controller do
  ...
  describe "POST 'lanalytics/track'" do
    ...
    it "should push a message into the RabbitMQ Queue" do
      expect(Msgr).to receive(:publish) do | marshalled_exp_api_stmt, msgr_params |
        ...
        expect(exp_api_stmt.ressource.type).to eq('Item')
        expect(exp_api_stmt.ressource.uuid).to eq('00000003-3100-4444-9999-000000000003')
  ...
  def request_data
    ...
    return {
      'actor' => { 'uuid' => "00000001-3100-4444-9999-000000000001" },
      'verb' => { "verb_key" => "video_play", "verb_id" => "http://lanalytics.open.hpi.de/expapi/verbs/video-play" },
      'ressource' => { "type" => "Item", "uuid" => "00000003-3100-4444-9999-000000000003" }
    }
  end
