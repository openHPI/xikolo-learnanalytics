        ...
        def transform(original_event, processing_units, load_commands, pipeline_ctx)
          processing_units.each do |punit|
            ...
            entity = Lanalytics::Processing::LoadORM::Entity.create(:referral) do
              ...
              with_attribute :course_id, :uuid, punit[:tracking_course_id] if punit[:tracking_course_id].present?
              ...
              with_attribute :tracking_id, :uuid, punit[:tracking_id] if punit[:tracking_id].present?
